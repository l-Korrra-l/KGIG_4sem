...
BEGIN_MESSAGE_MAP(CLab01App, CWinAppEx)
...
// Методы загрузки или сохранения настроек CLab01App

void CLab01App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CLab01App::LoadCustomState()
{
}

void CLab01App::SaveCustomState()
{
}
