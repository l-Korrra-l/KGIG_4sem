...
private:
	...
	CRect _myPlanet; //Моя планета

	CRect _earthOrbit, _moonOrbit, _mercuryOrbit;
	CRect _myPlanetOrbit; //Орбита моей планеты;

	CMatrix _earthCoords, _moonCoords, _mercuryCoords;
	CMatrix _myPlanetCoords; //Координаты моей поанеты
	CRect _rectWindow;
	CRectD _rectWorld;
	...
	double _myPlanetAngularVelocity; //Скорость моей планеты
	...
	double _myPlanetAngularPosition; //Угловая позиция моей планеты
